        ...
        <section class="services-section">
            <div class="container">
                ...
                <p class="services-subtitle">
                    J’accompagne mes clients de la conception à la mise en ligne, avec une expertise complète en développement web moderne.
                </p>
                ...
                <div class="services-grid">
                    <div class="service-card">
                        <div class="icon bg-indigo"><i class="fas fa-code"></i></div>
                        <h3>Frontend</h3>
                        <p>
                            Création d’interfaces modernes, réactives et intuitives avec HTML, CSS, JavaScript et frameworks modernes.
                        </p>
                    </div>

                    <div class="service-card">
                        <div class="icon bg-purple"><i class="fas fa-server"></i></div>
                        <h3>Backend</h3>
                        <p>
                            Développement robuste et sécurisé avec Laravel & NestJs, gestion des bases de données SQL & NoSQL.
                        </p>
                    </div>

                    <div class="service-card">
                        <div class="icon bg-pink"><i class="fas fa-pencil-ruler"></i></div>
                        <h3>Figma</h3>
                        <p>
                            Réalisation de maquettes professionnelles pour donner un aperçu précis du projet avant le développement.
                        </p>
                    </div>

                    <div class="service-card">
                        <div class="icon bg-green"><i class="fas fa-link"></i></div>
                        <h3>API</h3>
                        <p>
                            Création d’API puissantes avec NestJs pour connecter vos applications et échanger des données en toute sécurité.
                        </p>
                    </div>
